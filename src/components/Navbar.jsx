      ...
      <div className="nav sticky-top">
        <div className="nav_bar">
          <Link
            ...
            style={{
              ...
              fontFamily: "'Roboto Slab', serif", // Uses a stylish font
              textShadow: "2px 2px 4px rgba(0,0,0,0.5)", // Adds a shadow for a stylish effect
        ...
        {location.pathname == "/" && (
          <div className="sub_bar">
            ...
            <div className="items" onClick={() => filterbyPrice(14999)}>
              14999
            </div>
